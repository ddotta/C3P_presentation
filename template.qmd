...
4. **Enable notifications** : Active les notifications au niveau du navigateur (nécessite des autorisation côté navigateur et OS). Lorsqu'elle est activée, le navigateur affiche un message contextuel sur votre PC dès que la session est prête
